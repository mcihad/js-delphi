 ...
 */
export declare const VCL_VERSION = "1.0.0";
...
export type TCursor = 'crDefault' | 'crArrow' | 'crHandPoint' | 'crIBeam' | 'crCross' | 'crHourGlass' | 'crNo' | 'crSizeAll' | 'crSizeWE' | 'crSizeNS' | 'crHelp' | 'crDrag';
...
export type TFieldType = 'ftUnknown' | 'ftString' | 'ftInteger' | 'ftFloat' | 'ftCurrency' | 'ftBoolean' | 'ftDate' | 'ftDateTime' | 'ftTime' | 'ftMemo' | 'ftBlob';
export type TParamType = 'ptInput' | 'ptOutput' | 'ptInputOutput';
export type TGridOption = 'dgTitles' | 'dgIndicator' | 'dgColLines' | 'dgRowLines' | 'dgRowSelect' | 'dgAlwaysShowSelection' | 'dgEditing' | 'dgStriped';
export type TNavigateBtn = 'nbFirst' | 'nbPrior' | 'nbNext' | 'nbLast' | 'nbInsert' | 'nbDelete' | 'nbEdit' | 'nbPost' | 'nbCancel' | 'nbRefresh';
...
export declare function Rect(Left: number, Top: number, Right: number, Bottom: number): TRect;
export declare function Point(X: number, Y: number): TPoint;
/** Modal results (Delphi mrXxx constants). */
export type TModalResult = number;
export declare const mrNone = 0;
export declare const mrOk = 1;
export declare const mrCancel = 2;
export declare const mrAbort = 3;
export declare const mrRetry = 4;
export declare const mrIgnore = 5;
export declare const mrYes = 6;
export declare const mrNo = 7;
export declare const mrClose = 8;
export declare const mrAll = 12;
export declare const ModalResultNames: Record<string, number>;
export declare class EVclError extends Error {
    constructor(message: string);
}
export declare class EComponentError extends EVclError {
    constructor(message: string);
}
export declare class EListError extends EVclError {
    constructor(message: string);
}
export declare class EDatabaseError extends EVclError {
    constructor(message: string);
}
export declare class EConvertError extends EVclError {
    constructor(message: string);
}
export declare function IsValidIdent(name: string): boolean;
export declare function PtToPx(pt: number): number;
/** Strips '&' accelerators: "&Kaydet" → "Kaydet". */
export declare function StripAccel(caption: string): string;
/** Only allow image sources that cannot execute script. */
export declare function IsSafeImageSource(src: string): boolean;
/** All named colours, standard first (used by the Object Inspector colour editor). */
export declare const ColorNames: readonly string[];
export declare function IsValidColor(c: string): boolean;
/** Converts a Delphi colour (clRed, clBtnFace, $00BBGGRR, #RRGGBB) to a CSS colour. */
export declare function ColorToCSS(c: TColor): string;
/** Resolves any colour to #rrggbb (system colours use their default theme value). */
export declare function ColorToRGB(c: TColor): string;
export declare const FontNames: readonly string[];
export type TPropKind = 'int' | 'float' | 'string' | 'text' | 'bool' | 'enum' | 'set' | 'color' | 'font' | 'strings' | 'component' | 'connection' | 'table' | 'columns' | 'sql' | 'params' | 'image' | 'cursor' | 'datafield' | 'procname' | 'fieldlist' | 'modalresult' | 'fontname';
...
export declare function RegisterClass(cls: TComponentClass, info: TComponentInfo): void;
export declare function ClassNameOf(ctor: unknown): string;
/** Name of the nearest *registered* ancestor class (TButton for a user subclass of TButton). */
export declare function RegisteredClassOf(obj: TObject): string;
export declare function FindClass(name: string): TComponentClass | null;
export declare function GetClass(name: string): TComponentClass;
export declare function GetRegisteredClassNames(): string[];
/** RTTI with inherited properties/events merged (child overrides parent by name). */
export declare function GetClassInfo(name: string): TMergedComponentInfo | null;
export declare function InheritsFromClass(className: string, baseName: string): boolean;
export declare function FindPropInfo(className: string, prop: string): TPropInfo | null;
...
export declare class TStringList extends TStrings {
}
...
export declare class TFont extends TPersistent {
...
export declare const ElementOwner: WeakMap<Element, TControl>;
export declare class TComponent extends TPersistent {
    private FName;
    private FOwner;
    private FComponents;
...
export declare class TGraphicControl extends TControl {
}
export declare class TWinControl extends TControl {
...
export declare class TLabel extends TGraphicControl {
...
export declare class TButton extends TWinControl {
...
export declare class TEdit extends TWinControl {
...
export declare class TMemo extends TWinControl {
...
export declare class TComboBox extends TWinControl {
...
export declare abstract class TButtonControl extends TWinControl {
...
export declare class TCheckBox extends TButtonControl {
...
export declare class TRadioButton extends TButtonControl {
...
export declare class TImage extends TGraphicControl {
...
export declare class TProgressBar extends TWinControl {
...
export declare class TPanel extends TWinControl {
...
export declare class TGroupBox extends TWinControl {
    private FLegend;
    constructor(AOwner?: TComponent | null);
    protected GetDefaultSize(): {
        w: number;
...
export declare class TTabControl extends TWinControl {
...
export declare class TScrollBox extends TWinControl {
    protected FBorderStyle: TBorderStyle;
...
export declare class TTimer extends TComponent {
    protected FEnabled: boolean;
...
export declare function GetParentForm(AControl: TControl | null): TCustomForm | null;
/**
 ...
 */
export declare class TCustomForm extends TWinControl {
...
export declare class TForm extends TCustomForm {
}
export declare class TScreen extends TObject {
...
export declare class TApplication extends TComponent {
    Title: string;
...
export declare const Application: TApplication;
export declare const Screen: TScreen;
/** Delphi MessageDlg — resolves with the modal result of the pressed button. */
export declare function MessageDlg(Msg: string, DlgType?: TMsgDlgType, Buttons?: TMsgDlgBtn[], Caption?: string): Promise<TModalResult>;
/** Delphi ShowMessage (asynchronous: `await ShowMessage('…')`). */
export declare function ShowMessage(Msg: unknown): Promise<void>;
/** Yes/No confirmation helper. */
export declare function Confirm(Msg: string, Caption?: string): Promise<boolean>;
/** Delphi InputQuery — resolves with the entered text or null when cancelled. */
export declare function InputQuery(ACaption: string, APrompt: string, ADefault?: string): Promise<string | null>;
/** Delphi InputBox — resolves with ADefault when cancelled. */
export declare function InputBox(ACaption: string, APrompt: string, ADefault?: string): Promise<string>;
export declare function IntToStr(Value: number): string;
export declare function StrToInt(S: string): number;
export declare function StrToIntDef(S: string, Default: number): number;
export declare function FloatToStr(Value: number): string;
export declare function StrToFloat(S: string): number;
export declare function StrToFloatDef(S: string, Default: number): number;
/** FormatFloat('#,##0.00', 1234.5) → "1.234,50" (Turkish separators). */
export declare function FormatFloat(Format: string, Value: number): string;
/** FormatDateTime('dd.mm.yyyy hh:nn:ss', Now()). */
export declare function FormatDateTime(Format: string, D: Date): string;
export declare function Now(): Date;
export declare function Trim(S: string): string;
export declare function UpperCase(S: string): string;
export declare function LowerCase(S: string): string;
export declare function QuotedStr(S: string): string;
 ...
 */
export declare const IdeBridge: {
    Installed: boolean;
...
export declare function ExtractParamNames(SQL: string): string[];
...
export declare class TParam extends TPersistent {
    Name: string;
    DataType: TFieldType;
    ParamType: TParamType;
    private FValue;
...
export declare class TParams extends TPersistent {
    private FItems;
    get Count(): number;
...
export declare class TField extends TObject {
    FieldName: string;
    DataType: TFieldType;
    SqlType: string;
    Size: number;
...
export declare class TFields extends TObject {
    private FItems;
    get Count(): number;
...
export declare class TConnection extends TComponent {
...
export declare class TDataLink {
    private FDataSource;
...
export declare class TDataSource extends TComponent {
 ...
 */
export declare abstract class TDataSet extends TComponent {
...
export declare class TQuery extends TDataSet {
...
export declare class TTable extends TDataSet {
...
export declare class TStoredProc extends TDataSet {
...
export declare class TDBGrid extends TWinControl {
...
export declare class TDBNavigator extends TWinControl {
...
export declare class TDBEdit extends TEdit {
 ...
 */
export declare function SetPropValue(Comp: TComponent, Info: TPropInfo | string, Value: unknown, Resolve?: (Name: string) => TComponent | null): void;
/** Reads a published property as a JSON value (component references → names). */
export declare function GetPropValue(Comp: TComponent, Info: TPropInfo | string): unknown;
/** True when a property value equals its RTTI default (and therefore is not written). */
export declare function IsDefaultPropValue(Info: TPropInfo, Value: unknown): boolean;
/**
 ...
 */
export declare function LoadDesign(Form: TCustomForm, Doc: TDesignDocument | TDesignNode, Warn?: (m: string) => void): Map<string, TComponent>;
/** Serialises one component (non-default published properties only). */
export declare function SaveComponentNode(Comp: TComponent, Events?: Record<string, string>): TDesignNode;
/** Serialises a whole form (TWriter equivalent). Non-visual components follow the controls. */
export declare function SaveDesign(Form: TCustomForm): TDesignDocument;
export declare const EnumTypes: Record<string, readonly string[]>;
export declare const PaletteOrder: readonly string[];
export declare const CategoryLabels: Record<TPropCategory, string>;
...
export declare function GetRuntimeManifest(): TRuntimeManifest;
export {};
